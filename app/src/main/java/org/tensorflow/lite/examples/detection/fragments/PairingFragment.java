...
import org.tensorflow.lite.examples.detection.BChat;
import org.tensorflow.lite.examples.detection.Global;
import org.tensorflow.lite.examples.detection.R;
import org.tensorflow.lite.examples.detection.gui.ButtonSearch;
import org.tensorflow.lite.examples.detection.gui.CustomAnimator;
import org.tensorflow.lite.examples.detection.gui.GuiTools;
import org.tensorflow.lite.examples.detection.gui.PeerListAdapter;
import org.tensorflow.lite.examples.detection.gui.RequestDialog;
import org.tensorflow.lite.examples.detection.tools.Tools;
...
public class PairingFragment extends Fragment {
    ...
    private BChat.Callback communicatorCallback;
    private CustomAnimator animator = new CustomAnimator();
    private Peer connectingPeer;
    protected Global global;
    protected BChat activity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        communicatorCallback = new BChat.Callback() {
            @Override
            ...
            public void onConnectionSuccess(Peer peer, int source) {
                ...
                activity.setFragment(BChat.CONVERSATION_FRAGMENT);
            }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        activity = (BChat) requireActivity();
    ...
    public void onStart() {
        ...
        if (!Tools.hasPermissions(activity, BChat.REQUIRED_PERMISSIONS)) {
            startSearch();
        }
    ...
    protected void startSearch() {
        ...
        if (result != BluetoothCommunicator.SUCCESS) {
            ...
            } else if (result != BChat.NO_PERMISSIONS && result != BluetoothCommunicator.ALREADY_STARTED) {
